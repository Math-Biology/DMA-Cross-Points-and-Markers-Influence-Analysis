...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P408\_\#2018m11d06-P408\_V13547\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P408\_\#2018m11d06-P408\_V13547\_FreeProtocol}:
\begin{enumerate}
...
\bottomrule
\endlastfoot
RF - 1 - e & Escherichia Vit - Prodotti della Vittoria & 1 & 100.0 \\
RF - 1 - e & Herpes simplex & 1 & 100.0 \\
RF - 1 - e & Papilloma Virus & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
LF - 1 - e & --- & --- & --- & --- \\
LF - 4 - e & --- & --- & --- & --- \\
RF - 1 - e & -150.00 & 223.33 & 2.0 & 150.00 \\
RF - 4 - e & --- & --- & --- & --- \\
RH - 2 - i & --- & --- & --- & --- \\
\end{longtable}
\end{small}
