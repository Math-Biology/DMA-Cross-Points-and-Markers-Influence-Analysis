...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P770\_\#2022m05d09-P770\_V3604\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P770\_\#2022m05d09-P770\_V3604\_FreeProtocol}:
\begin{enumerate}
...
LF - 1 - e & Mercurio (Presenza) & 1 & 100.0 \\
LF - 1 - e & Zinco Oligoelemento & 1 & 100.0 \\
LH - 2 - i & Sys Cardo mariano & 1 & 100.0 \\
RF - 2 - e & Mercurio (Presenza) & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
\bottomrule
\endlastfoot
LF - 1 - e & -89.13 & 167.39 & 2.5 & 83.70 \\
LH - 2 - i & -92.19 & 184.38 & 3.0 & 92.19 \\
LH - 5 - e & --- & --- & --- & --- \\
RF - 2 - e & -116.67 & 233.33 & 3.0 & 116.67 \\
\end{longtable}
\end{small}
