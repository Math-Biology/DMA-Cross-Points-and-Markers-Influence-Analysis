...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P707\_\#2020m08d26-P707\_V15483\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P707\_\#2020m08d26-P707\_V15483\_FreeProtocol}:
\begin{enumerate}
...
\endlastfoot
LF - 1 - i & --- & --- & --- & --- \\
LH - 1 - c & -214.81 & 209.26 & 2.0 & 209.26 \\
RF - 1 - i & --- & --- & --- & --- \\
RH - 2 - c & -255.17 & 0.00 & 1.0 & 0.00 \\
\end{longtable}
\end{small}
