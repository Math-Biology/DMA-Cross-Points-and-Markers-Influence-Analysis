...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P208\_\#2015m09d14-P208\_V9296\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P208\_\#2015m09d14-P208\_V9296\_FreeProtocol}:
\begin{enumerate}
...
\bottomrule
\endlastfoot
RF - 5 - e & XO (Xantina Ossidasi) & 1 & 100.0 \\
RH - 2 - i & 3-Nitro Tirosina & 1 & 100.0 \\
RH - 2 - i & XO (Xantina Ossidasi) & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
LH - 5 - e & --- & --- & --- & --- \\
RF - 1 - e & --- & --- & --- & --- \\
RF - 5 - e & --- & 0.00 & 1.0 & 0.00 \\
RH - 2 - i & -76.47 & 76.47 & 2.0 & 38.24 \\
\end{longtable}
\end{small}
