...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P221\_\#2016m09d06-P221\_V12981\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P221\_\#2016m09d06-P221\_V12981\_FreeProtocol}:
\begin{enumerate}
...
RH - 5 - e & Chlamydia psittaci & 1 & 100.0 \\
RH - 5 - e & FMS Bufo - Igeakos & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
RH - 5 - e & -171.14 & 263.64 & 3.0 & 172.73 \\
RH - 5 - i & --- & --- & --- & --- \\
\end{longtable}
\end{small}
