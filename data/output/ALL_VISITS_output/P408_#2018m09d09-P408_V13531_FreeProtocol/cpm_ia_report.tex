...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P408\_\#2018m09d09-P408\_V13531\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P408\_\#2018m09d09-P408\_V13531\_FreeProtocol}:
\begin{enumerate}
...
\bottomrule
\endlastfoot
LF - 3 - i & -250.89 & 275.00 & 2.0 & 137.50 \\
RF - 3 - c & -229.55 & 763.64 & 4.0 & 254.55 \\
RF - 4 - c & --- & --- & --- & --- \\
RH - 4 - e & --- & --- & --- & --- \\
\end{longtable}
\end{small}
