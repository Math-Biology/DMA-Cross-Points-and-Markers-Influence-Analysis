...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P251\_\#2021m09d19-P251\_V388\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P251\_\#2021m09d19-P251\_V388\_FreeProtocol}:
\begin{enumerate}
...
LF - 1 - e & Idrossicobalamina & 1 & 100.0 \\
...
\bottomrule
\endlastfoot
LF - 1 - e & -247.83 & 247.83 & 2.0 & 247.83 \\
LH - 2 - i & --- & --- & --- & --- \\
LH - 5 - e & --- & --- & --- & --- \\
\end{longtable}
\end{small}
