...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P164\_\#2015m01d30-P164\_V16278\_FreeProtocol} \\
...
Unique visits                          & 1 \\
Unique anatomical points               & 45 \\
Unique markers across all visits       & 1 \\
(Visit,\,point) series analysed        & 45 \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P164\_\#2015m01d30-P164\_V16278\_FreeProtocol}:
\begin{enumerate}
...
\noindent
Of the \textbf{45} (visit,\,point) series analysed,
\textbf{0} (\textbf{0.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{0} of \textbf{45} unique anatomical points
