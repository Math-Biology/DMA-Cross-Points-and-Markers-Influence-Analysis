...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P447\_\#2018m02d14-P447\_V929\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P447\_\#2018m02d14-P447\_V929\_FreeProtocol}:
\begin{enumerate}
...
RF - 1 - e & Mucor racemosus & 1 & 100.0 \\
...
\endlastfoot
LF - 4 - e & --- & --- & --- & --- \\
RF - 1 - e & -475.00 & 0.00 & 1.0 & 0.00 \\
RF - 1 - i & --- & --- & --- & --- \\
RH - 2 - i & --- & --- & --- & --- \\
RH - 5 - e & -136.54 & 273.08 & 3.0 & 136.54 \\
\end{longtable}
\end{small}
