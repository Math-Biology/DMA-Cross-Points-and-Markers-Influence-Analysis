...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P152\_\#2015m03d17-P152\_V8018\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P152\_\#2015m03d17-P152\_V8018\_FreeProtocol}:
\begin{enumerate}
...
\textbf{5} (\textbf{62.5}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{5} of \textbf{8} unique anatomical points
...
LH - 5 - c & --- & 0.00 & 1.0 & 0.00 \\
RF - 3 - c & --- & 0.00 & 1.0 & 0.00 \\
RF - 3 - i & --- & --- & --- & --- \\
RH - 2 - c & --- & 0.00 & 1.0 & 0.00 \\
RH - 5 - c & --- & --- & --- & --- \\
\end{longtable}
\end{small}
