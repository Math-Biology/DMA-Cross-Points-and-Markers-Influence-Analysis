...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P302\_\#2016m09d20-P302\_V12644\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 1 (\,20.0\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P302\_\#2016m09d20-P302\_V12644\_FreeProtocol}:
\begin{enumerate}
...
\textbf{1} (\textbf{20.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{1} of \textbf{5} unique anatomical points
...
\bottomrule
\endlastfoot
RF - 4 - e & Biotad Plus & 1 & 100.0 \\
RF - 4 - e & Candida albicans & 1 & 100.0 \\
RF - 4 - e & Meridian Komplex 8 & 1 & 100.0 \\
RF - 4 - e & Meristemo 21 - PromoPharma & 1 & 100.0 \\
RF - 4 - e & Meristemo 8 - PromoPharma & 1 & 100.0 \\
RF - 4 - e & Oxistres - Forza Vitale & 1 & 100.0 \\
RF - 4 - e & Trichophytum rubrum & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
