...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P758\_\#2021m01d22-P758\_V4924\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P758\_\#2021m01d22-P758\_V4924\_FreeProtocol}:
\begin{enumerate}
...
\endlastfoot
LF - 1 - i & --- & --- & --- & --- \\
LF - 5 - i & -439.13 & 0.00 & 1.0 & 0.00 \\
LH - 5 - e & -157.69 & 157.69 & 2.0 & 157.69 \\
RF - 1 - e & -206.00 & 206.00 & 2.0 & 206.00 \\
\end{longtable}
\end{small}
