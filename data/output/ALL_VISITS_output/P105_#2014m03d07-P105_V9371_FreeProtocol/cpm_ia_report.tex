...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P105\_\#2014m03d07-P105\_V9371\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 1 (\,12.5\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P105\_\#2014m03d07-P105\_V9371\_FreeProtocol}:
\begin{enumerate}
...
\textbf{1} (\textbf{12.5}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{1} of \textbf{8} unique anatomical points
...
\bottomrule
\endlastfoot
RH - 3 - c & Profito CIRC & 1 & 100.0 \\
RH - 3 - c & Profito CR - OHI & 1 & 100.0 \\
RH - 3 - c & Profito FG & 1 & 100.0 \\
RH - 3 - c & Profito IT - OHI & 1 & 100.0 \\
RH - 3 - c & Profito RN & 1 & 100.0 \\
RH - 3 - c & Profito ST & 1 & 100.0 \\
RH - 3 - c & Profito VS - OHI & 1 & 100.0 \\
RH - 3 - c & Profito VSB - OHI & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
RF - 3 - i & --- & --- & --- & --- \\
RH - 2 - c & --- & --- & --- & --- \\
RH - 3 - c & -260.00 & 120.00 & 1.5 & 70.00 \\
\end{longtable}
\end{small}
