...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P76\_\#2014m03d26-P76\_V465\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 2 (\,20.0\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P76\_\#2014m03d26-P76\_V465\_FreeProtocol}:
\begin{enumerate}
...
\textbf{2} (\textbf{20.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{2} of \textbf{10} unique anatomical points
...
LH - 2 - c & --- & --- & --- & --- \\
LH - 2 - e & --- & --- & --- & --- \\
LH - 4 - e & -325.00 & 325.00 & 2.0 & 325.00 \\
RF - 3 - c & --- & --- & --- & --- \\
RH - 4 - e & -230.77 & 246.15 & 2.0 & 158.97 \\
RH - 4 - i & --- & --- & --- & --- \\
\end{longtable}
\end{small}
