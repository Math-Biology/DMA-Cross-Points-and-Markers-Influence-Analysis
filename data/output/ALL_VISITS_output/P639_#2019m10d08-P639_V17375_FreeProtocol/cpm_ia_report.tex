...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P639\_\#2019m10d08-P639\_V17375\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 4 (\,6.7\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P639\_\#2019m10d08-P639\_V17375\_FreeProtocol}:
\begin{enumerate}
...
\textbf{4} (\textbf{6.7}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{4} of \textbf{60} unique anatomical points
