...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P1047\_\#2023m08d27-P1047\_V3871\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P1047\_\#2023m08d27-P1047\_V3871\_FreeProtocol}:
\begin{enumerate}
...
\endlastfoot
LF - 1 - e & --- & --- & --- & --- \\
LH - 2 - i & -523.81 & 0.00 & 1.0 & 0.00 \\
RH - 2 - i & --- & 0.00 & 1.0 & 0.00 \\
RH - 5 - e & -198.75 & 198.75 & 2.0 & 198.75 \\
RH - 5 - i & -400.00 & 200.00 & 1.5 & 200.00 \\
\end{longtable}
\end{small}
