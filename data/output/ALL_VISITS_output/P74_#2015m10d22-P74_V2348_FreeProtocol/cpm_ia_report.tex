...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P74\_\#2015m10d22-P74\_V2348\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P74\_\#2015m10d22-P74\_V2348\_FreeProtocol}:
\begin{enumerate}
...
LH - 5 - e & IL-27 & 1 & 100.0 \\
RH - 2 - i & IL-1beta & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
\endlastfoot
LH - 2 - i & --- & --- & --- & --- \\
LH - 5 - e & -175.00 & 175.00 & 2.0 & 175.00 \\
RH - 2 - i & -200.00 & 200.00 & 2.0 & 200.00 \\
RH - 5 - e & --- & --- & --- & --- \\
\end{longtable}
\end{small}
