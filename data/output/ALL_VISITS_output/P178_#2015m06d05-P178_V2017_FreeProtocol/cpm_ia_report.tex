...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P178\_\#2015m06d05-P178\_V2017\_FreeProtocol} \\
...
Unique visits                          & 1 \\
Unique anatomical points               & 9 \\
Unique markers across all visits       & 8 \\
(Visit,\,point) series analysed        & 9 \\
Positive (visit,\,point) series        & 4 (\,44.4\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P178\_\#2015m06d05-P178\_V2017\_FreeProtocol}:
\begin{enumerate}
...
\noindent
Of the \textbf{9} (visit,\,point) series analysed,
\textbf{4} (\textbf{44.4}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{4} of \textbf{9} unique anatomical points
...
LH - 3 - e & -216.67 & 0.00 & 1.0 & 0.00 \\
LH - 4 - c & -230.30 & 178.79 & 2.0 & 178.79 \\
