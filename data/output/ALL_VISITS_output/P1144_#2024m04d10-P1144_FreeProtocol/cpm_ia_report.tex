...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P1144\_\#2024m04d10-P1144\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P1144\_\#2024m04d10-P1144\_FreeProtocol}:
\begin{enumerate}
...
\bottomrule
\endlastfoot
RH - 1 - c & mã\_x0083\_â rker 05 & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
LF - 5 - c & --- & --- & --- & --- \\
LF - 5 - e & --- & --- & --- & --- \\
RH - 1 - c & -333.33 & 333.33 & 2.0 & 333.33 \\
\end{longtable}
\end{small}
