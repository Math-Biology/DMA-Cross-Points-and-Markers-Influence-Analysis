...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P1194\_\#2025m04d30-P1194\_V7743\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 2 (\,28.6\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P1194\_\#2025m04d30-P1194\_V7743\_FreeProtocol}:
\begin{enumerate}
...
\textbf{2} (\textbf{28.6}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{2} of \textbf{7} unique anatomical points
...
\bottomrule
\endlastfoot
LH - 2 - c & L-acetilcarnitina 500mg & 1 & 100.0 \\
...
\endlastfoot
LF - 1 - i & --- & --- & --- & --- \\
LH - 2 - c & -438.89 & 438.89 & 2.0 & 438.89 \\
LH - 5 - i & --- & --- & --- & --- \\
RF - 1 - i & -138.24 & 276.47 & 3.0 & 138.24 \\
RF - 5 - e & --- & --- & --- & --- \\
RH - 1 - i & --- & --- & --- & --- \\
RH - 3 - e & --- & --- & --- & --- \\
\end{longtable}
