...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P305\_\#2021m07d16-P305\_V237\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P305\_\#2021m07d16-P305\_V237\_FreeProtocol}:
\begin{enumerate}
...
RH - 1 - c & --- & --- & --- & --- \\
RH - 2 - i & --- & --- & --- & --- \\
RH - 5 - e & -150.00 & 190.00 & 2.0 & 150.00 \\
\end{longtable}
\end{small}
