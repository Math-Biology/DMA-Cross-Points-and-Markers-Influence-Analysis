...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P305\_\#2018m04d14-P305\_V16979\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 3 (\,5.0\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P305\_\#2018m04d14-P305\_V16979\_FreeProtocol}:
\begin{enumerate}
...
\textbf{3} (\textbf{5.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{3} of \textbf{60} unique anatomical points
