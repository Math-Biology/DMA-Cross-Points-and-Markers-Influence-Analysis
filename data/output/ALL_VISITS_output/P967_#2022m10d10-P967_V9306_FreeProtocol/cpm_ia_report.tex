...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P967\_\#2022m10d10-P967\_V9306\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P967\_\#2022m10d10-P967\_V9306\_FreeProtocol}:
\begin{enumerate}
...
\bottomrule
\endlastfoot
LF - 1 - e & -260.94 & 331.25 & 2.0 & 190.62 \\
LH - 2 - i & --- & 0.00 & 1.0 & 0.00 \\
LH - 5 - e & -143.75 & 143.75 & 2.0 & 71.88 \\
RF - 1 - i & --- & --- & --- & --- \\
RH - 5 - i & --- & --- & --- & --- \\
\end{longtable}
\end{small}
