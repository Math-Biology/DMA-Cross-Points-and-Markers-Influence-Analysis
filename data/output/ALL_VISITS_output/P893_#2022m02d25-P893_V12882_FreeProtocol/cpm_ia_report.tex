...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P893\_\#2022m02d25-P893\_V12882\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P893\_\#2022m02d25-P893\_V12882\_FreeProtocol}:
\begin{enumerate}
...
\bottomrule
\endlastfoot
LF - 3 - c & -127.78 & 155.56 & 3.0 & 127.78 \\
LF - 5 - c & --- & --- & --- & --- \\
RF - 3 - e & -102.94 & 205.88 & 3.0 & 102.94 \\
\end{longtable}
\end{small}
