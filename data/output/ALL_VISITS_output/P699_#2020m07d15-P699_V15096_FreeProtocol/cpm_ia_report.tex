...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P699\_\#2020m07d15-P699\_V15096\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P699\_\#2020m07d15-P699\_V15096\_FreeProtocol}:
\begin{enumerate}
...
LH - 4 - i & --- & --- & --- & --- \\
LH - 5 - c & --- & --- & --- & --- \\
RH - 1 - c & -102.50 & 205.00 & 3.0 & 102.50 \\
RH - 3 - e & -168.75 & 168.75 & 2.0 & 168.75 \\
\end{longtable}
\end{small}
