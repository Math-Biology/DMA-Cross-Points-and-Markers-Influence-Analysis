...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P171\_\#2015m02d04-P171\_V845\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 2 (\,25.0\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P171\_\#2015m02d04-P171\_V845\_FreeProtocol}:
\begin{enumerate}
...
\textbf{2} (\textbf{25.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{2} of \textbf{8} unique anatomical points
...
RH - 2 - e & rock water rigiditã\_x0083\_â & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
LH - 4 - c & --- & --- & --- & --- \\
LH - 4 - e & --- & --- & --- & --- \\
LH - 5 - c & -311.11 & 0.00 & 1.0 & 0.00 \\
RH - 1 - c & --- & --- & --- & --- \\
RH - 1 - e & --- & --- & --- & --- \\
RH - 2 - e & -342.11 & 342.11 & 2.0 & 342.11 \\
\end{longtable}
\end{small}
