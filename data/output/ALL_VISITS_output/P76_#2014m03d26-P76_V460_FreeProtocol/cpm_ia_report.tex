...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P76\_\#2014m03d26-P76\_V460\_FreeProtocol} \\
...
Positive (visit,\,point) series        & 1 (\,10.0\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P76\_\#2014m03d26-P76\_V460\_FreeProtocol}:
\begin{enumerate}
...
\textbf{1} (\textbf{10.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{1} of \textbf{10} unique anatomical points
...
LH - 2 - c & --- & --- & --- & --- \\
LH - 2 - e & --- & --- & --- & --- \\
LH - 4 - e & -580.00 & 580.00 & 2.0 & 580.00 \\
RF - 3 - c & --- & --- & --- & --- \\
RH - 4 - e & --- & --- & --- & --- \\
RH - 4 - i & --- & --- & --- & --- \\
\end{longtable}
