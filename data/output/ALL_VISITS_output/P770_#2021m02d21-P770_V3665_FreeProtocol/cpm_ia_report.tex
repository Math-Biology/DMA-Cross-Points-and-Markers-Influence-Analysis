...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P770\_\#2021m02d21-P770\_V3665\_FreeProtocol} \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P770\_\#2021m02d21-P770\_V3665\_FreeProtocol}:
\begin{enumerate}
...
LH - 5 - e & Componente grassa del latte & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
\endlastfoot
LF - 1 - e & --- & --- & --- & --- \\
LF - 2 - e & -311.11 & 311.11 & 2.0 & 311.11 \\
LH - 5 - e & -238.46 & 238.46 & 2.0 & 238.46 \\
LH - 5 - i & --- & --- & --- & --- \\
\end{longtable}
\end{small}
