...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P81\_\#2015m06d22-P81\_V16320\_FreeProtocol} \\
...
Unique visits                          & 1 \\
Unique anatomical points               & 38 \\
Unique markers across all visits       & 1 \\
(Visit,\,point) series analysed        & 38 \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P81\_\#2015m06d22-P81\_V16320\_FreeProtocol}:
\begin{enumerate}
...
\noindent
Of the \textbf{38} (visit,\,point) series analysed,
\textbf{0} (\textbf{0.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{0} of \textbf{38} unique anatomical points
