...
Output path                       & \texttt{data/output/AF\_\#2026m03d03-AF\_FreeProtocol} \\
...
\midrule
Total rows ingested                        & 143 \\
Rows dropped (empty keys)                  & 0 \\
Invalid points found / rows affected       & 1 / 11 \\
Total anchors detected                     & 3 \\
Unique visits                          & 1 \\
Unique anatomical points               & 12 \\
Unique markers across all visits       & 11 \\
(Visit,\,point) series analysed        & 12 \\
Positive (visit,\,point) series        & 3 (\,25.0\,\%) \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/AF\_\#2026m03d03-AF\_FreeProtocol}:
\begin{enumerate}
...
\noindent
Of the \textbf{12} (visit,\,point) series analysed,
\textbf{3} (\textbf{25.0}\,\%) yielded at least one
excitation event above the threshold $\theta = 300.0\,\%$.
\textbf{3} of \textbf{12} unique anatomical points
...
\bottomrule
\endlastfoot
LF - 2 - e - Stomach & 1 & 0 & 0.0 \\
LF - 3 - e - Spinal cord & 1 & 0 & 0.0 \\
LF - 4 - e - Gallbladder & 1 & 0 & 0.0 \\
LF - 5 - i - Kidney & 1 & 0 & 0.0 \\
LH - 2 - i - colon & 1 & 0 & 0.0 \\
LH - 5 - i - Heart & 1 & 0 & 0.0 \\
RF - 1 - e - Liver & 1 & 1 & 100.0 \\
RF - 1 - i - Pancreas & 1 & 1 & 100.0 \\
RF - 2 - e - Stomach & 1 & 0 & 0.0 \\
RF - 5 - e - Bladder & 1 & 1 & 100.0 \\
RH - 1 - i - lung & 1 & 0 & 0.0 \\
RH - 5 - e - Small intestine & 1 & 0 & 0.0 \\
\end{longtable}
\end{small}
...
\bottomrule
\endlastfoot
RF - 1 - e - Liver & TNF-alfa & 1 & 100.0 \\
RF - 1 - i - Pancreas & IL-8 & 1 & 100.0 \\
RF - 5 - e - Bladder & IL-8 & 1 & 100.0 \\
\end{longtable}
\end{footnotesize}
...
LH - 2 - i - colon & --- & --- & --- & --- \\
LH - 5 - i - Heart & --- & --- & --- & --- \\
RF - 1 - e - Liver & --- & 0.00 & 1.0 & 0.00 \\
RF - 1 - i - Pancreas & -27.37 & 27.37 & 2.0 & 27.37 \\
RF - 2 - e - Stomach & --- & --- & --- & --- \\
RF - 5 - e - Bladder & -293.40 & 293.40 & 2.0 & 293.40 \\
RH - 1 - i - lung & --- & --- & --- & --- \\
RH - 5 - e - Small intestine & --- & --- & --- & --- \\
\end{longtable}
\end{small}
