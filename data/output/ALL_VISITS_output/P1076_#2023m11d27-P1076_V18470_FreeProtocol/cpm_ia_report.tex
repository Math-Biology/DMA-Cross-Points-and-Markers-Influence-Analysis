...
Output path                       & \texttt{data/output/ALL\_VISITS\_output/P1076\_\#2023m11d27-P1076\_V18470\_FreeProtocol} \\
...
\midrule
Total rows ingested                        & 62 \\
Rows dropped (empty keys)                  & 0 \\
Invalid points found / rows affected       & 2 / 2 \\
...
The pipeline produces three artefacts in the output directory \texttt{data/output/ALL\_VISITS\_output/P1076\_\#2023m11d27-P1076\_V18470\_FreeProtocol}:
\begin{enumerate}
